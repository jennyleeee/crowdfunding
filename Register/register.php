			...
			<form class="contact100-form validate-form">
			   ...
			   Sign Up
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input id="password1" class="input100" type="password" name="password" placeholder="Enter your password...">
					<span class="focus-input100"></span>
				</div>


				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<label class="label-input100" for="email">RepeatPassword</label>
					<input id="password2" class="input100" type="password" name="password" placeholder="Enter your password again...">
					<span class="focus-input100"></span>
				</div>
