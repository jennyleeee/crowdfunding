   ...
   <!-- Header -->
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Crowd Funding</div><p>
          <div class="intro-heading text-uppercase"> 은은하게 위대하게 <br> <p>내 지갑의 작은 일탈</div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="Main_wallet/Main_wallet.php">Tell Me More</a>
        </div>
      </div>
    </header>
    ...
    <!-- Services -->
     ...
     <section id="about">
       <div class="container">
         <div class="row">
           <h5 class="section-heading text-uppercase">진행중인 기획전 </h5>
           <p>
           <div class="col-lg-12 text-center">
             <a class="nav-link js-scroll-trigger" href="../Main_Jeju/Main_jeju.php" onclick="">
             <img class="img-fluid" src="img/ad.PNG" alt=""> </a>
           </div>
         </div>
    ...
    <section id="contact">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <form id="contactForm" name="sentMessage" novalidate="novalidate" method="post" action="mainpage.php">
              <div class="row">
                <div class="col-md-6">
