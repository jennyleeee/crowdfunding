...
if($page != 1) {
$paging .= '<li class="page page_start"><a href="board_include.php?page=1">처음</a></li>';
}

//첫 섹션이 아니라면 이전 버튼을 생성
if($currentSection != 1) {
$paging .= '<li class="page page_prev"><a href="board_include.php?page=' . $prevPage . '">이전</a></li>';
}
...
$paging .= '<li class="page"><a href="board_include.php?page=' . $i . '">' . $i . '</a></li>';
}
}
//마지막 섹션이 아니라면 다음 버튼을 생성
if($currentSection != $allSection) {
$paging .= '<li class="page page_next"><a href="board_include.php?page=' . $nextPage . '">다음</a></li>';
}
//마지막 페이지가 아니라면 끝 버튼을 생성
if($page != $allPage) {
$paging .= '<li class="page page_end"><a href="board_include.php?page=' . $allPage . '">끝</a></li>';
}
$paging .= '</ul>';
/* 페이징 끝 */
